# Copied from https://www.reddit.com/r/adventofcode/comments/18nevo3/comment/keavm0j/?utm_source=share&utm_medium=web2x&context=3
with open("assets/day21/in.txt", "r") as file:
